...
*   **Home Assistant Reporting**: Sends CPU/GPU power statistics to a Home Assistant/MQTT broker via [myScript/HomeAssistant/](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/HomeAssistant/) (`invia_watt.sh`, requires `MQTT_PASS` in `~/.config/mqtt.env`; `ryzen_monitor/` is a vendored C tool).
*   **Jellyfin Backup**: [myScript/BackupJellyfin/](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/BackupJellyfin/) contains [backupJellyfin.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/BackupJellyfin/backupJellyfin.sh) for automated configuration backups.
...
*   **AI/ML Server Management ([myScript/AI/](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/AI/))**: [OllamaServer.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/AI/OllamaServer.sh), [StableDiffusionWebUI.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/AI/StableDiffusionWebUI.sh), [SwarmUI.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/AI/SwarmUI.sh) for managing local AI/ML servers.
*   **Automatic Lockscreen ([myScript/Lockscreen/](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/Lockscreen/))**: Scripts for configuring and managing automatic screen locking.
*   **Keyboard Shortcut Management ([myScript/ExportKeyboardShortcut/](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/ExportKeyboardShortcut/))**: Tools to export and load custom keyboard shortcuts (see [Keybindings_README.md](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/ExportKeyboardShortcut/Keybindings_README.md)).
*   **GNOME Extensions Backup ([myScript/ExportGnomeExtensions/](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/ExportGnomeExtensions/))**: Lightweight backup of the enabled GNOME Shell extensions (UUID list + dconf settings, no extension files). [ExportGnomeExtensions.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/ExportGnomeExtensions/ExportGnomeExtensions.sh) runs automatically via `rsync_sync.service` (`ExecStartPre`); [RestoreGnomeExtensions.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/ExportGnomeExtensions/RestoreGnomeExtensions.sh) re-downloads and re-installs them from extensions.gnome.org.
*   **Audio Output Switching ([myScript/Audio/](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/Audio/))**: Scripts to switch PulseAudio default sinks to [Speakers](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/Audio/Casse.sh), [Headphones](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/Audio/Cuffie.sh), or [Bluetooth headset](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/Audio/BackBeatPro2.sh).
*   **MPV Player Configuration ([configs/mpv/](file:///home/lorenzo/Documenti/GitHub/dotfiles/configs/mpv/))**: Synced by `rSync.sh` from the real config in use (`~/.config/mpv`):
...
*   **Rsync Operations ([myScript/rSync/](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/rSync/))**: Scripts for efficient file backup and synchronization (`rSync.sh`, `rSync_NoCommit.sh`) including `exclude.txt`.
*   **Display Switching ([myScript/Display/](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/Display/))**: Scripts like [ReturnToDesktop.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/Display/ReturnToDesktop.sh), [ReturnToDesktop60Hz.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/Display/ReturnToDesktop60Hz.sh), [ReturnToTV.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/Display/ReturnToTV.sh), [ReturnToTV_Delayed.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/Display/ReturnToTV_Delayed.sh), and the resolution-change hooks [PreCambioRisolzione.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/Display/PreCambioRisolzione.sh) / [PostCambioRisoluzione.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/Display/PostCambioRisoluzione.sh) for managing display outputs.
*   **Video Search & Convert ([myScript/VideoTools/](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/VideoTools/))**: Scripts for converting and verifying video files, including [Converti e verifica.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/VideoTools/Converti%20e%20verifica.sh), [VideoTools.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/VideoTools/VideoTools.sh), and the test video generators [crea_test_video.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/VideoTools/crea_test_video.sh) / [Create_corrupted_video.sh](file:///home/lorenzo/Documenti/GitHub/dotfiles/myScript/VideoTools/Create_corrupted_video.sh).
...
*   **Application Services**: [lmstudio.service](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/lmstudio.service), [sunshine.service](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/sunshine.service) for managing specific applications.
*   **Timers**: [flatpak-update.timer](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/flatpak-update.timer), [invia-watt.timer](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/invia-watt.timer), [jellyfin-backup.timer](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/jellyfin-backup.timer), [lmstudio.timer](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/lmstudio.timer), [rsync_sync.timer](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/rsync_sync.timer), [Shutdown.timer](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/Shutdown.timer) for scheduling tasks.
*   **Utility Services**: [flatpak-update.service](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/flatpak-update.service), [invia-watt.service](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/invia-watt.service), [jellyfin-backup.service](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/jellyfin-backup.service), [rsync_sync.service](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/rsync_sync.service), [Shutdown.service](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/Shutdown.service), [xbox-monitor.service](file:///home/lorenzo/Documenti/GitHub/dotfiles/systemd/user/xbox-monitor.service) for system maintenance, gaming controller configuration, and automation.
...
*   Nota: `protonvpn_reconnect.service` è gestita automaticamente dall'app ProtonVPN ed è esclusa dal backup (`exclude.txt`).
...
*   **MPV Shaders**: Ensure your MPV installation supports GLSL shaders. The shaders are located in `configs/mpv/shaders/`.
